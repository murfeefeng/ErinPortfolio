...
(function(l) {
    ...
    function lb(a, b, c) {
        var d = a._iDisplayStart,
            e = a._iDisplayLength,
            h = a.fnRecordsDisplay();
        0 === h || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > h && (d = 0)) : "first" == b ? d = 0 : "prev" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) :
    ...
    var dc =
        u.ext.pager;
    l.extend(dc, { simple: function(a, b) { return ["prev", "next"] }, full: function(a, b) { return ["first", "prev", "next", "last"] }, numbers: function(a, b) { return [Da(a, b)] }, simple_numbers: function(a, b) { return ["prev", Da(a, b), "next"] }, full_numbers: function(a, b) { return ["first", "prev", Da(a, b), "next", "last"] }, first_last_numbers: function(a, b) { return ["first", Da(a, b), "last"] }, _numbers: Da, numbers_length: 7 });
